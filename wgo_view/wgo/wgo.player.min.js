...
f.active)for(var b in f.query){var d=document.getElementById(b);if(d&&d._wgo_player){d.scrollIntoView();break}}});var h=function(){if(f.query[this.element.id])return f.query[this.element.id].goto};b.Player.default.move=h;b.BasicPlayer&&b.BasicPlayer.component.Control&&b.BasicPlayer.component.Control.menu.push({constructor:b.BasicPlayer.control.MenuItem,args:{name:"permalink",click:function(f){var d=location.href.split("#")[0]+'&'+f.kifuReader.path.m;f.showMessage("<h1>"+
